...
label __no_help:
    ...
    "My plea was answered by a sharp bark from the foremost wolf, followed up by barks from the two others behind it. {w}I was about to turn around and make a run for it, when the wolves finally decided to jump at me."
...
label __postermm_lose:
    $ save_name = _("Posters are dangerous...")
...
label __beforespeech:
    ...
    show froggy hi
    "I nodded meekly at the mayor. He then pulled a tape dispenser from his hat, somehow balancing the stack of posters on only one of his arms, and handed it to me."
...
label __dragon_eat:
    ...
    show froggy hi_talking at left, flip with move
